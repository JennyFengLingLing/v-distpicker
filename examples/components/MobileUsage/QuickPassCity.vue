    ...
    <div class="example">
      ...
      <div class="example-box">
        <div class="box-left d-flex align-items-baseline">
          <div class="col-md-7">
            <v-distpicker quick-pass-city type="mobile" wrapper="address-wrapper" @province="selectProvince" @city="selectCity" @area="selectArea" address-container="address-container"></v-distpicker>
          </div>
